...
// constructor
	...
	<p><label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of services to show (-1 shows all):', 'bldr' ); ?></label>
    ...
    <p><label for="<?php echo $this->get_field_id('see_all'); ?>"><?php _e('<em>Optional:</em> Enter the URL for your Services page.', 'bldr'); ?></label>
	...
	function widget($args, $instance) {
		...
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : __( 'Services', 'bldr' ); 
...
?>
        ...
        <div class="grid grid-pad">
				...
				<?php while ( $mt->have_posts() ) : $mt->the_post(); ?>
					...
					<div class="col-1-3 tri-clear animate-plus" data-animations="fadeIn" data-animation-when-visible="true" data-animation-delay="0.2s">
