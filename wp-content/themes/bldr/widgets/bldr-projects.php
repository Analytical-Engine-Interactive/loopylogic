...
// constructor
	...
	<p><label for="<?php echo sanitize_text_field( $this->get_field_id( 'number' )); ?>"><?php _e( 'Number of projects to show (-1 shows all):', 'bldr' ); ?></label>
    ...
    <p><label for="<?php echo sanitize_text_field( $this->get_field_id('see_all')); ?>"><?php _e('<em>Optional:</em> Enter the URL for your Projects page.', 'bldr'); ?></label>
	...
	function widget($args, $instance) {
		...
		$title = ( ! empty( $instance['title'] ) ) ? esc_html( $instance['title'] ) : __( 'Projects', 'bldr' ); 
