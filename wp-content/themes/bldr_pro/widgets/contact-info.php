...
// constructor
	...
	<p><label for="<?php echo $this->get_field_id( 'address' ); ?>"><?php _e( 'Enter your address', 'bldr' ); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id( 'phone' ); ?>"><?php _e( 'Enter your phone number', 'bldr' ); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id( 'email' ); ?>"><?php _e( 'Enter your email address', 'bldr' ); ?></label>
	...
	function widget($args, $instance) {
		...
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : __( 'Contact info', 'bldr' );
		...
		if( ($address) ) {
			...
			echo '<span>' . __('Address: ', 'bldr') . '</span>' . $address;
		...
		if( ($phone) ) {
			...
			echo '<span>' . __('Phone: ', 'bldr') . '</span>' . $phone;
		...
		if( ($email) ) {
			...
			echo '<span>' . __('Email: ', 'bldr') . '</span>' . '<a href="mailto:' . $email . '">' . $email . '</a>';
