...
function bldr_add_customizer_css() {
	...
	<style>
		...
		.site-header-home h1.site-title a { color: <?php echo esc_attr( get_theme_mod( 'bldr_site_title_color', __( '#ffffff', 'bldr' ) )) ?>; } 
		<?php endif; ?>
		...
		<?php if ( get_theme_mod( 'bldr_skill_bar' ) ) : ?>  
		 .progressBar div { background-color: <?php echo esc_attr( get_theme_mod( 'bldr_skill_bar', __( '#039be5', 'bldr' ) )) ?>; } 
		<?php endif; ?> 
		...
		<?php if ( get_theme_mod( 'bldr_mobile_menu_bg' ) ) : ?>  
		.cbp-spmenu { background-color: <?php echo esc_attr( get_theme_mod( 'bldr_mobile_menu_bg', '#1e2022'  )) ?>; } 
		<?php endif; ?>
		
		<?php if ( get_theme_mod( 'bldr_mobile_menu_link' ) ) : ?>  
		.cbp-spmenu a { color: <?php echo esc_attr( get_theme_mod( 'bldr_mobile_menu_link', '#ffffff'  )) ?>; } 
		<?php endif; ?>
		
		<?php if ( get_theme_mod( 'bldr_mobile_menu_sublink' ) ) : ?>  
		.cbp-spmenu ul.sub-menu li a { color: <?php echo esc_attr( get_theme_mod( 'bldr_mobile_menu_sublink', '#999999'  )) ?>; } 
		<?php endif; ?> 
		
		<?php if ( get_theme_mod( 'bldr_mobile_hover_bg' ) ) : ?>  
		.cbp-spmenu a:hover { background-color: <?php echo esc_attr( get_theme_mod( 'bldr_mobile_hover_bg', '#0e0e0e'  )) ?>; } 
		<?php endif; ?> 
		
		<?php if ( get_theme_mod( 'bldr_close_text' ) ) : ?>  
		.cbp-spmenu h3 { color: <?php echo esc_attr( get_theme_mod( 'bldr_close_text', '#ffffff'  )) ?>; } 
		<?php endif; ?> 
		
		<?php if ( get_theme_mod( 'bldr_close_bg' ) ) : ?>  
		.cbp-spmenu h3 { background-color: <?php echo esc_attr( get_theme_mod( 'bldr_close_bg', '#0e0e0e'  )) ?>; } 
		<?php endif; ?> 
